...
public sealed class ExpectedIncome
{
 ...
 public void Update(string name,Money amount,DateOnly date,Frequency frequency,bool confirmed,Guid? accountId){Name=name.Trim();_amount=amount.Amount;_currency=amount.Currency;ExpectedDate=date;Frequency=frequency;IsConfirmed=confirmed;DestinationFinancialAccountId=accountId;}
