...
public sealed class Transaction
{
    ...
    public Transaction(Guid userId, Guid accountId, Guid? relatedAccountId, Guid? categoryId,
        ...
        Guid? transferGroupId=null, TransferDirection? transferDirection=null,Guid? debtId=null)
    {
        ...
        TransferGroupId=transferGroupId;TransferDirection=transferDirection;DebtId=debtId;
    }
    ...
    public void Update(Guid accountId, Guid? relatedAccountId, Guid? categoryId, TransactionType type,
        Money amount, DateOnly date, string description)
    {
        if(amount.Amount<=0) throw new DomainException("Transaction amount must be positive.");
        ...
        Type=type; _amount=amount.Amount; _currency=amount.Currency; TransactionDate=date; Description=description.Trim();
    }
